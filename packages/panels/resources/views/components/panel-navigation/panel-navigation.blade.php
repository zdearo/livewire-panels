...
<section
         ...
         <flux:sidebar.item
            ...
            <x-slot name="icon">
               <x-icon
                  ...
                  class="size-4"
                  data-livewire-panels-navigation-icon />
            </x-slot>
            @endif
   ...
   @else
   <flux:header container data-livewire-panels-topbar>
      <flux:button
         class="lg:hidden shrink-0"
         variant="subtle"
         square
      ...
      <flux:navbar class="-mb-px max-lg:hidden">
         ...
         @else
         <flux:navbar.item
            :wire:navigate="$this->navigationItemUsesSpa($navigationGroup->items[0])"
   ...
   <flux:sidebar sticky collapsible="mobile" class="lg:hidden" data-livewire-panels-mobile-sidebar>
      <flux:sidebar.header>
